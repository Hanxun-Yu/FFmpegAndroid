 ...
 */
public class ResolutionTargetDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mDecideButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pickerRes != null) {
                    sizeParamUtil.setWH_OUT(pickerRes[0]);
                }
    ...
    protected void initChild() {
        List<String> sizeList = Arrays.asList(sizeParamUtil.getWH_OUTList());
...
//                }
        ...
        onePicker.setSelectIndex(sizeParamUtil.getWH_OUT());
    }
