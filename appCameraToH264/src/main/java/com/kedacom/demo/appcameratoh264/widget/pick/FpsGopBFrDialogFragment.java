 ...
 */
public class FpsGopBFrDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mDecideButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pickerRes != null) {
                    x264ParamUtil.setFps(pickerRes[0]);
                    x264ParamUtil.setGop(pickerRes[1]);
                    x264ParamUtil.setBFrame(pickerRes[2]);
                }
    ...
    protected void initChild() {
        List<String> FpsList = Arrays.asList(x264ParamUtil.getFpsList());
        List<String> GopList = Arrays.asList(x264ParamUtil.getGopList());
        List<String> BFrameList = Arrays.asList(x264ParamUtil.getBFrameList());

        profilePicker.initDataList(new ParentPicker.PickerData<>(FpsList, null),
                new ParentPicker.PickerData<>(GopList, "s"),
                new ParentPicker.PickerData<>(BFrameList, null));
...
//                }
        ...
        profilePicker.setSelectIndex(x264ParamUtil.getFps(),x264ParamUtil.getGop(),
                x264ParamUtil.getBFrame());
    }
